...
Scenario: clicking on book image leads to larger image
  When I click on Mediation book image
  	Then I should be on the Mediation image popup page
...
Scenario: clicking on the link to purchase page leads to correct links
  When I click on Mediation purchase link
  	Then I should be on the Mediation purchase link
...
Scenario: clicking on the title leads to detailed description of the book
  When I click on Mediation 
  	Then I should see more details about Mediation

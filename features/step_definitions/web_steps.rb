...
When /the test database has been seeded/ do
...
Then /^(?:|I )should (not )?see \/([^\/]*)\/$/ do |should_not_see, regexp|
  regexp = Regexp.new(regexp)

  if page.respond_to? :should
    if not should_not_see
...
Then /^the "([^"]*)" field(?: within (.*))? should (not )?contain "([^"]*)"$/ do |field, parent, should_not, value|

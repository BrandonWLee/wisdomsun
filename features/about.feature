...
Scenario: About page
  ...
  And I am on the admin About page
...
Scenario: About Ari page
  Given I am logged in as admin
  And I am on the admin About Ari page
...
Scenario: on the About Rose page
  Given I am logged in as admin
  And I am on the admin About Rose page
...
Scenario: Lineage page
  Given I am logged in as admin
  And I am on the admin Lineage page
...
Scenario: Teaching Series for Purchase
  Given I am logged in as admin
  And I am on the admin Teaching Series for Purchase page
...
Scenario: Personal Sessions
  Given I am logged in as admin
  And I am on the admin Personal Sessions page
